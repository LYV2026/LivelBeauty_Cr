        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {items.map((item, index) => (
            <div key={index} className="flex flex-col items-center text-center gap-2">
              <div className="w-12 h-12 rounded-full bg-brand-nude flex items-center justify-center text-brand-taupe mb-1">
                {item.icon}
              </div>
              <h3 className="text-sm font-bold text-stone-900 uppercase tracking-wider">{item.title}</h3>
